      ...
      <div className="flex justify-between items-center gap-6">
        <div className="flex-1">
          <p className="mb-6 text-xl">
            ...
            make their cities better. Our Public Infrastructure Issue Reporting
            System makes it easy for anyone to report, track, and resolve public
            issues—all in one place.
          </p>
          <ol className="text-lg list-disc pl-10 text-balance space-y-2">
            <li>
              <strong>Fast and simple reporting:</strong> Capture problems like
              broken streetlights, potholes, or damaged sidewalks with a photo
              and location pin.
            </li>
            <li>
            ...
            <li>
              ...
              submitted issues, from “reported” to “resolved,” and get notified
              when your city fixes the problem.
            </li>
            <li>
          ...
          <p className="mt-6 text-xl">
            With this system, your report isn’t just a message—it’s a real step
            toward a safer, cleaner, and smarter city.
          </p>
        </div>
        <div className="flex-1">
          <img src={SideImg} alt="" />
